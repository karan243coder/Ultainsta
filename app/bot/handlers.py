...
async def admin_callbacks(call: CallbackQuery):
    ...
    if data == "admin_stats":
        ...
        await safe_edit(call.message, "🔄 <b>Auto-Monitor Management</b>", reply_markup=monitor_menu("admin_mon"), parse_mode="HTML")
...
async def monitor_callbacks(call: CallbackQuery):
    ...
    if action == "close":
        ...
        return
    if action == "main":
        await safe_edit(call.message, "🔄 <b>Profile Auto-Monitor Center</b>", reply_markup=monitor_menu(prefix), parse_mode="HTML")
    elif action == "list":
        ...
        if not mons:
            ...
            return
        await safe_edit(call.message, "❌ Select profile to stop monitoring:", reply_markup=monitor_delete_menu(mons, prefix), parse_mode="HTML")
